...
enc_cmsgpack = cmsgpack.Encoder()
enc_msgspec = msgspec.msgpack.Encoder()

dec_cmsgpack = cmsgpack.Decoder()
dec_msgspec = msgspec.msgpack.Decoder()

print(f"\n# MessagePack serialization benchmarks:\n ({ITERATIONS} iterations)\n")
print("#-- Module --#-- Encoding --#-- Decoding --#")

bench("Cmsgpack", lambda: enc_cmsgpack.encode(v), lambda: dec_cmsgpack.decode(b_cmsgpack))
bench("Msgspec", lambda: enc_msgspec.encode(v), lambda: dec_msgspec.decode(b_msgspec))
